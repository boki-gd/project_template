...
gltf_primitives_to_mesh_primitives(Memory_arena* arena, Gltf_primitive* primitive)
{
    ...
    result.vertex_size = sizeof(Vertex);
    result.vertices = ARENA_PUSH_STRUCTS(arena,Vertex, primitive->vertices_count);
    Vertex* vertices = (Vertex*)result.vertices;
